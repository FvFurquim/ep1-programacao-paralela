...
void init(int argc, char *argv[]){
    if(argc < 7){
        ...
        printf("    Full Picture:         ./mandelbrot_omp -2.5 1.5 -2.0 2.0 11500 3\n");
        printf("    Seahorse Valley:      ./mandelbrot_omp -0.8 -0.7 0.05 0.15 11500 3\n");
        printf("    Elephant Valley:      ./mandelbrot_omp 0.175 0.375 -0.1 0.1 11500 7\n");
        printf("    Triple Spiral Valley: ./mandelbrot_omp -0.188 -0.012 0.554 0.754 11500 20\n");
        exit(0);
    }
    else{
